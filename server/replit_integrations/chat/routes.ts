...
export function registerChatRoutes(app: Express): void {
  ...
  app.post("/api/conversations/:id/messages", isAuthenticated, async (req: any, res: Response) => {
    try {
      ...
      // Add system prompt for baseball context
      const messagesWithSystem = [
        { role: "system", content: "You are an elite baseball coach and mentor. Provide expert advice on mechanics, mindset, recruiting, and development for athletes aged 13-18 and their parents." },
        ...chatMessages
      ];
